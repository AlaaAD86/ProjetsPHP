...
<head>
    ...
    <title>VILLES - METTRE EN FORME PHP</title>
...
<!-- =================== UNE FACON A FAIRE LE TABLEAU =============================== -->

    <?php  
        echo '<table><tbody>'; 
        foreach(['ville','departement','latitude','longitude','population','densite'] as $values) {
    ...
    <!-- =========================== UNE AUTRE FACON A FAIRE LE TABLEAU ====================== -->
